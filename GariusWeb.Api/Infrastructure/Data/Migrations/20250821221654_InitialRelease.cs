    ...
    public partial class InitialRelease : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailSearch = table.Column<string>(type: "text", nullable: true, computedColumnSql: "regexp_replace(lower(coalesce(\"Email\",'')), '[@._+-]', ' ', 'g')", stored: true),
                    SearchVector = table.Column<NpgsqlTsVector>(type: "tsvector", nullable: false)
                        .Annotation("Npgsql:TsVectorConfig", "simple")
                        .Annotation("Npgsql:TsVectorProperties", new[] { "UserName", "Email", "FullName" }),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "f2a9a058-9853-4014-9562-d0da2718da10", "SuperAdmin", "SUPERADMIN", "Super Admin", 1, Guid.NewGuid().ToString() },
                    { "01988a9c-2bfc-70d5-a6dc-22f911179bd0", "Owner", "OWNER", "Dono do sistema", 2, Guid.NewGuid().ToString() },
                    { "01988035-d4b4-7896-8222-7e20fd0a7a90", "Admin", "ADMIN", "Administrador do sistema", 3, Guid.NewGuid().ToString() },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 
                    new Guid("c0f5f2a9-a058-4014-9562-d0da2718da10"), 
                    new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 
                    true, 
                    "Default Tenant", 
                    new DateTime(2025, 8, 21, 22, 9, 12, 86, DateTimeKind.Utc).AddTicks(8934) 
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                ...
                {
                    new Guid("0198801d-f235-7c32-8d1f-1d216b0b7032"),
                    new Guid("f2a9a058-9853-4014-9562-d0da2718da10"),
                    new Guid("01988a9c-2bfc-70d5-a6dc-22f911179bd0"),
                    new Guid("01988035-d4b4-7896-8222-7e20fd0a7a90"),
                    new Guid("3cd743ab-14be-4606-81ac-1c5d79f6a54a")
                });

            migrationBuilder.DeleteData(
                table: "Tenants",
                keyColumn: "Id",
                keyValue: new Guid("c0f5f2a9-a058-4014-9562-d0da2718da10"));
